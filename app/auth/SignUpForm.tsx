...
const SignUpForm: React.FC<SignUpFormProps> = ({ onToggle }) => {
    ...
    return (
        <div className="sign-up-bg bg-cover min-h-screen bg-gray-100 flex flex-col justify-center sm:px-6 lg:px-8">
            <div className="mx-auto w-full max-w-md">
                <div className="bg-white py-8 px-4 shadow sm:rounded-lg sm:px-10">
                        ...
                        <div>
                            ...
                            <div className="auth-btns flex flex-col gap-2">
                                <button
                                    ...
                                    disabled={isLoading}
                                    className="w-full flex justify-center items-center py-2 px-4 gap-3 border border-transparent rounded-md shadow-sm text-sm font-medium text-white bg-red-600 hover:bg-red-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-red-500"
                                    >
                                ...
                                <button
                                    ...
                                    disabled={isLoading}
                                    className="w-full flex justify-center items-center py-2 px-4 gap-3 border border-transparent rounded-md shadow-sm text-sm font-medium text-white bg-gray-600 hover:bg-gray-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-gray-500"
                                    >
                    ...
                    <AuthToggle isSignUp={true} onToggle={onToggle} />
                </div>
            </div>
            <ToastContainer />
        </div>
